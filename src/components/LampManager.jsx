                ...
                <tbody>
                    {filteredLamps.map((lamp) => (
                        <tr key={lamp.deviceid} className="hover:bg-gray-50 border-b">
                            ...
                            {/* CỘT TRẠNG THÁI HIỆN TẠI (Lấy từ dữ liệu quét 5s của App) */}
                            <td className="p-3 border font-bold">
                                {lamp.isOn ? <span className="text-green-600 flex items-center gap-1">🟢 Đang Sáng ({lamp.dimLevel}%)</span> : <span className="text-gray-400 flex items-center gap-1">⚪ Đã Tắt</span>}
                            </td>
